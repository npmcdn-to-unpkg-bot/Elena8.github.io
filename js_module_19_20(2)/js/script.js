...
var dt= [
    ...
    
  {
    ...
    console.log("skills:");
var skills=_.map(dt,'skills');
    console.log(skills);
    skills = _.flatten(skills);
    console.log(skills);
    skills = _.uniq(skills);
    console.log(skills);
    skills=_.sortBy(skills, function(s){ //sorturuem po alfavity
    return s.toLowerCase().charCodeAt();
    });
    console.log(skills);

console.log("names:");   
var names=_.map(dt,'names');
    names = _.flatten(names);
    names = _.sortBy(dt, function (o) { // сортируем по количеству друзей
    return o.friends.length;
    });
    console.log(names);
    
    console.log("friends:");  
var fr=_.map(dt,'friends');
    console.log(fr);
    fr=_.flatten(fr);
    fr=_.map(fr,'name');
    console.log(fr);
