...
obj.createText(classLi1[0], 'Вопрос №1', 0);
obj.createLabels('br', 'br', classLi1[0]);
obj.createText(classLi2[0], 'Вопрос №2', 0);
obj.createLabels('br', 'br', classLi2[0]);
obj.createText(classLi3[0], 'Вопрос №3', 0);
obj.createLabels('br', 'br', classLi3[0]);
//create labels
var j;
for (j = 0; j < 3; j + 1) {
